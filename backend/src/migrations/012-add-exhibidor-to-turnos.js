...
function up(queryInterface) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, queryInterface.addColumn('turnos', 'exhibidor', {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, queryInterface.removeIndex('turnos', 'turnos_fecha_hora_lugar_exhibidor_unique')];
                case 1:
                    // Remover índice único
                    _a.sent();
                    // Remover columna
                    return [4 /*yield*/, queryInterface.removeColumn('turnos', 'exhibidor')];
                case 2:
                    // Remover columna
                    _a.sent();
                    return [2 /*return*/];

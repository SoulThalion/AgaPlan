...
function up(queryInterface) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, queryInterface.createTable('usuarios', {
                        id: {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, queryInterface.addIndex('usuarios', ['email'], {
                            unique: true,
...
function down(queryInterface) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, queryInterface.dropTable('usuarios')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }

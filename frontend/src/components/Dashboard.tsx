...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral dark:bg-neutral-dark">
      {/* Header */}
      <header className="bg-white dark:bg-neutral-dark shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="container-responsive">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold font-poppins text-neutral-text dark:text-white">
                AgaPlan
              </h1>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:flex items-center space-x-3">
                <div className="text-right">
                  ...
                  <p className="text-xs font-roboto text-gray-500 dark:text-gray-400 capitalize">
                    {user?.rol}
                  </p>
                </div>
